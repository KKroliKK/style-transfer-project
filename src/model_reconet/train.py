...
from losses import *
from utils import (tensors_sum, occlusion_mask_from_flow, gram_matrix, preprocess_for_reconet,
                   preprocess_for_vgg, postprocess_reconet, RunningLossesContainer)
...
if __name__ == "__main__":
    ...
    with torch.cuda.device(gpu_device):
        ...
        flyingthings3d = FlyingThings3DDataset(os.path.join(data_dir, "flyingthings3d"), transform)
